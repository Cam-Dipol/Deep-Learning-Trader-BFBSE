...
def export_quote_logs(traders, tracked_trader_types, output_path):
    ...
    with open(output_path, mode='a', newline='') as file:
        ...
        if not file_exists:
            headers = ['time', 'bid_ask_spread', 'midprice', 'micro_price', 'best_bid', 'best_ask', 'p_eq', 'q_eq', 'trader_type', 'Order_type', 'limit_price', 'quote_price']
